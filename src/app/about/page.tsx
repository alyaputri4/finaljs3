...
export default function AboutPage() {
  return (
    <main
      className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-8"
      style={{
    ...
    >
      <section className="bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md p-8 w-full max-w-xl flex flex-col items-center">
        ...
        <div className="space-y-4 text-lg w-full">
          <p>
            <span className="font-semibold">Nama:</span> Alya Nasmi Rahma Putri
          </p>
          <p>
            <span className="font-semibold">Kelas:</span> XI RPL B
          </p>
          <p>
          ...
          <div className="mt-6 w-full aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/RMJ4kvEf-ws?si=zZLux8cVPS_-ZfxB"
              title="YouTube video"
